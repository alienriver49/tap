...
define('models/IExtensionLoadingInfo',["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});

define('tap-fx/event-bus',["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define('shell/shell',["require", "exports", "./../tap-fx/tap-rpc/event-bus"], function (require, exports, event_bus_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Shell = (function () {
        function Shell() {
        ...
        Shell.prototype.registerEventBus = function () {
            this._subscriptions.push(event_bus_1.EventBus.getDefault().subscribe('extension.new-blade', this.handleNewBladeMessage));
        };
...
define('tap-fx/tap-rpc/event-bus',["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var EventBus = (function () {
        function EventBus(_a) {
...
define('tap-fx/tap-rpc/tap-rpc',["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var EventBus = (function () {
        function EventBus(_a) {
...
define("tap-fx/tap-ux/tap-ux-controls/tap-ux-blade", [],function(){});

define('tap-fx/tap-ux/tap-ux-controls/blade',["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Blade = (function () {
        function Blade() {
...
define('text!tap-fx/tap-ux/tap-ux-controls/tap-ux-blade.html', ['module'], function(module) { module.exports = "<template><div>I am a Blade!</div><input type=\"text\" bind.value=\"extensionName\"></template>"; });
define('text!tap-fx/tap-ux/tap-ux-controls/blade.html', ['module'], function(module) { module.exports = "<template><div>I am a Blade!</div><input type=\"text\" bind.value=\"extensionName\"></template>"; });
