...
export const RELEASE_TAP_FX_BUILD_ROOT: string = join(RELEASE_TAP_FX_ROOT, 'src');
...
export const RELEASE_TAP_WEB_COMPONENTS_BUILD_ROOT: string = join(RELEASE_TAP_WEB_COMPONENTS_ROOT, 'src');
