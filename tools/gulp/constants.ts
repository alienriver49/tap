...
export const RELEASE_TAP_FX_DIST_ROOT: string = join(RELEASE_PACKAGES_ROOT, 'tap-fx', 'dist');
...
export const TAP_FX_COMMONJS_BUNDLE_NAME: string = 'tap-fx.cjs.js';
...
export const RELEASE_TAP_PORTAL_DIST_ROOT: string = join(RELEASE_PACKAGES_ROOT, 'tap-portal', 'dist');
...
export const TAP_PORTAL_COMMONJS_BUNDLE_NAME: string = 'tap-portal.cjs.js';
